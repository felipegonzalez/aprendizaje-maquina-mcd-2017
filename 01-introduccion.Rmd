...
Y buscamos reducir el valor promedio de 
...
Supongamos que tenemos un conjunto de datos *etiquetados*
$${\mathcal L} = \{ (x_i,y_i) \}_{i=1}^N$$

que llamamos **conjunto de entrenamiento**.
Buscamos definir un algoritmo que asigne a este conjunto de entrenamiento una
función
