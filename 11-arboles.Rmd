...
La idea es entonces es intentar decorrelacionar árboles sin inducir demasiada varianza.


## Bosques aleatorios

Los bosques aleatorios son una versión de árboles de bagging decorrelacionados. El proceso
es como sigue.

El proceso de decorrelación consiste en que cada vez que tengamos que hacer
...
### Ejemplo
Regresamos a nuestro ejemplo de spam:
