...
- Pérdida cuadrática: $L(y,z)=(y-z)^2$, 
$\frac{\partial L}{\partial z} = -2(y-z)$.
- Përdida absoluta (más robusta que la cuadrática) $L(y,z)=|y-z|$,
$\frac{\partial L}{\partial z} = signo(y-z)$.
- Devianza binomial $L(y, z)$ = -\log(1+e^{-yz}), $y\in\{-1,1\}$,
$\frac{\partial L}{\partial z} = I(y=1) - p(x)$.
