...
7. Utiliza el inciso anterior para calcular $\frac{\partial D}{\partial \theta_{1,1}^{(2)}}$, $\frac{\partial D}{\partial \theta_{1,2}^{(2)}}$
y $\frac{\partial D}{\partial \theta_{1,0}^{(2)}}$. ¿Puedes explicar los
